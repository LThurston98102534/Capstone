...
int main(int argc, char **argv)
{
   ...
   *
   * The third argument below "assignment05" is the rosnode name
   ...
   */
  ros::init(argc, argv, "realsenseARTag");
  ...
  std::shared_ptr<ROSDataBuffer> rdb(new ROSDataBuffer(nh));


  std::thread t(&ROSDataBuffer::exploreUnknown,rdb);
