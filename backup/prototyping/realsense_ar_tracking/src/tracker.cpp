    ...
    if (msg->markers.at(i).id == 4) {
      ...
      try{
        ...
        ROS_INFO("sensor_pose Position: (%.2f, %.2f. %.2f) \nsensor_pose Orientation: (%.2f, %.2f, %.2f, %.2f) ----->\nbase_link Position: (%.2f, %.2f, %.2f)\nbase_link Orientation: (%.2f, %.2f, %.2f, %.2f) \nat time %.2f",
            sensor_pose.pose.position.x, sensor_pose.pose.position.y, sensor_pose.pose.position.z, sensor_pose.pose.orientation.x, sensor_pose.pose.orientation.y, sensor_pose.pose.orientation.z, sensor_pose.pose.orientation.w,            base_pose.pose.position.x, base_pose.pose.position.y, base_pose.pose.position.z, base_pose.pose.orientation.x, base_pose.pose.orientation.y, base_pose.pose.orientation.z, base_pose.pose.orientation.w, sensor_pose.header.stamp.toSec());
      }
